    ...
    <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 w-full h-full min-h-[400px]">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <div className="text-[10px] bg-amber-50 text-amber-600 px-2 py-1 rounded font-black uppercase">Growth</div>
        </div>
        <div className="h-[300px] w-full">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={data} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
              ...
              <Area type="monotone" dataKey="simpanan" name="Simpanan" stroke="#B47B5A" strokeWidth={3} fillOpacity={1} fill="url(#colorSimpanan)" animationDuration={2000} />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      </div>
        ...
        <div className="h-[300px] w-full">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={data} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
              ...
              <YAxis hide={true} />
              <Tooltip content={<CustomTooltip />} />
              <Bar dataKey="pinjaman" name="Pinjaman" fill="#D19A62" radius={[6, 6, 0, 0]} barSize={30} animationDuration={2000} />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </div>
