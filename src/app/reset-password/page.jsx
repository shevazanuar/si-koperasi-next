    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
        <div className="bg-white p-8 rounded-3xl shadow-xl text-center max-w-md w-full">
          ...
          <Link href="/lupa-password" className="inline-block bg-amber-700 text-white px-6 py-2 rounded-xl font-medium hover:bg-amber-800 transition-colors">
            Minta Link Baru
          </Link>
        </div>
      </div>
        ...
        <div className="bg-white p-8 sm:p-10 rounded-[2.5rem] shadow-2xl shadow-blue-900/10 border border-white relative overflow-hidden">
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-amber-50 rounded-2xl mb-6">
              <Lock className="text-amber-700 w-8 h-8" />
            </div>
            <h1 className="text-2xl font-black text-gray-900 tracking-tight mb-2">Buat Password Baru</h1>
            <p className="text-gray-400 text-sm font-medium px-4">Silakan masukkan password baru Anda yang kuat dan mudah diingat.</p>
          </div>
          ...
          {!state?.success ? (
            <form action={formAction} className="space-y-5">
              ...
              <button
                disabled={isPending}
                className="w-full bg-amber-700 hover:bg-amber-800 text-white font-bold py-4 rounded-2xl transition-all shadow-lg shadow-amber-500/20 active:scale-[0.98] disabled:opacity-70 flex items-center justify-center gap-2 mt-4"
              >
            ...
            <div className="text-center space-y-6 animate-in slide-in-from-bottom-4">
              <div className="flex flex-col items-center justify-center gap-3 bg-amber-50 border border-amber-100 text-amber-700 p-6 rounded-2xl">
                <CheckCircle2 className="w-12 h-12 mb-2" />
                <span className="text-sm font-bold">{state.success}</span>
              </div>
              <Link href="/login" className="inline-block w-full bg-amber-700 text-white font-bold py-4 rounded-2xl hover:bg-amber-800 transition-colors shadow-lg shadow-amber-500/20">
                Masuk Sekarang
              </Link>
            </div>
          )}
