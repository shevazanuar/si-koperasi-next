...
export default function EditBankForm({ bank }) {
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                name="nomor_rekening"
                type="text"
                defaultValue={bank.nomor_rekening}
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                name="nama_pemilik"
                type="text"
                defaultValue={bank.nama_pemilik}
                onInput={(e) => { e.target.value = e.target.value.replace(/[^a-zA-Z\s]/g, ''); }}
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-4">
              <label className="flex-1 cursor-pointer">
                <input type="radio" name="status" value="Aktif" defaultChecked={bank.status === "Aktif" || !bank.status} className="hidden peer" />
              ...
              <label className="flex-1 cursor-pointer">
                <input type="radio" name="status" value="Tidak Aktif" defaultChecked={bank.status === "Tidak Aktif"} className="hidden peer" />
