        ...
        <form onSubmit={handleGenerate} className="flex flex-col md:flex-row gap-4 items-end">
          ...
          <div className="flex-1 w-full">
            ...
            <select 
              ...
              className="w-full border-gray-300 rounded-md shadow-sm focus:border-amber-400 focus:ring-amber-500/20 py-2 px-3 border"
            >
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="btn-primary w-full md:w-auto justify-center disabled:opacity-50"
          >
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50">
            ...
            <button 
              ...
              className="px-4 py-2 bg-orange-50 text-orange-700 border border-orange-200 text-sm font-medium rounded-md hover:bg-orange-100 flex items-center gap-2"
            >
            ...
            <table className="w-full text-left text-sm">
              ...
              <tbody className="divide-y divide-gray-200">
                ...
                <tr className="bg-gray-50">
                  ...
                  <td className="px-4 py-4 text-right font-bold text-emerald-700 text-lg">{formatRupiah(data.total)}</td>
                </tr>
              </tbody>
            </table>
          </div>
