    ...
    <div className="space-y-4 animate-in fade-in duration-500 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm">
          ...
          <p className="text-2xl font-black text-amber-700">Rp {fmt(totalPendapatan)}</p>
        </div>
        <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm">
        ...
        <div className="bg-emerald-600 p-5 rounded-2xl border border-emerald-500 shadow-sm shadow-emerald-700/20 text-white">
          <p className="text-sm font-bold text-emerald-100 uppercase tracking-widest mb-1">Total Laba Bersih</p>
          ...
          <table className="w-full text-sm text-left border-collapse">
            <thead>
              <tr className="bg-gray-50 text-gray-500 text-[11px] uppercase font-bold tracking-wider border-b border-gray-200">
                ...
                <th className="py-3 px-4 text-right text-emerald-600">Laba</th>
              </tr>
            </thead>
