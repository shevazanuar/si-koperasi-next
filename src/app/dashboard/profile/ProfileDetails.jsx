...
export default function ProfileDetails({ userData }) {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-20">
      {/* Profile Header Card */}
      <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-2xl shadow-amber-900/5 overflow-hidden">
        <div className="bg-gradient-to-r from-amber-600 to-orange-700 p-8 sm:p-12 text-white relative">
          <div className="relative z-10 flex flex-col sm:flex-row items-center gap-6">
            ...
            <div className="text-center sm:text-left">
              ...
              <div className="flex flex-wrap justify-center sm:justify-start gap-3 mt-3">
                <span className="px-3 py-1 bg-white/20 backdrop-blur-md rounded-lg text-xs font-bold uppercase tracking-wider border border-white/20">{userData.role === "admin" ? "Administrator" : "Anggota Koperasi"}</span>
          ...
          <div className="absolute bottom-0 left-1/2 w-32 h-32 bg-amber-400/20 rounded-full blur-2xl"></div>
        </div>
        ...
        <div className="p-8 sm:p-12 grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="bg-slate-50/50 p-8 rounded-[2rem] border border-slate-100">
            ...
            <form action={formAction} className="space-y-5">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-white border border-gray-100 rounded-xl py-3 pl-11 pr-4 text-sm text-gray-900 placeholder:text-gray-300 focus:outline-none focus:ring-4 focus:ring-amber-500/10 focus:border-amber-500/50 transition-all font-medium"
                      required
                    />
                  </div>
                </div>
              ...
              <button
                disabled={isPending}
                className="w-full bg-amber-600 hover:bg-amber-700 text-white text-xs font-bold py-4 rounded-xl transition-all shadow-lg shadow-amber-500/20 active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-2"
              >
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-6 px-10">
        ...
        <p className="text-[10px] font-bold text-gray-300 uppercase tracking-[0.2em]">SI Koperasi Polines System</p>
      </div>
    </div>
  );
}
